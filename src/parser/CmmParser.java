...
public class CmmParser extends Parser {
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			setState(19);
			match(T__5);
			 ((ProgramContext)_localctx).ast =  new Program(((ProgramContext)_localctx).varDefinitions.ast, ((ProgramContext)_localctx).statements.ast); 
			}
		}
	...
	public final StatementsContext statements() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 3671048L) != 0)) {
				{
				{
				setState(38);
