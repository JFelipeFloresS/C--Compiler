...
public class StructAccess extends AbstractExpression {
	...
	private StructRecordField structRecordField;
	...
	public StructRecordField getStructRecordField() {
		return structRecordField;
	}

	public void setStructRecordField(StructRecordField structRecordField) {
		this.structRecordField = structRecordField;
	}
}
